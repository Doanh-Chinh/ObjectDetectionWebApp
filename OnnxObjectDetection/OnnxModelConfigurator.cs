...
namespace OnnxObjectDetection
{
    public class OnnxModelConfigurator
    {
        ...
        private ITransformer SetupMlNetModel(IOnnxModel onnxModel)
        {
            ...
            //var pipeline = mlContext.Transforms.ResizeImages(resizing: ImageResizingEstimator.ResizingKind.Fill, outputColumnName: "images", imageWidth: ImageSettings.imageWidth, imageHeight: ImageSettings.imageHeight, inputColumnName: nameof(ImageInputData.Images))
            ...
            //.Append(mlContext.Transforms.ApplyOnnxModel(modelFile: onnxModel.ModelPath, outputColumnName: onnxModel.ModelOutput, inputColumnName: "images"));
